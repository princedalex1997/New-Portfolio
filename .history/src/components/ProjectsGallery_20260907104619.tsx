...
const PROJECTS: Project[] = [
  {
    ...
    description:
      "A scalable e-commerce application focused on structured user flows, efficient state management, and consistent UI design. Built to demonstrate how complex frontend state can be managed cleanly while maintaining performance across devices.",
    tech: ["React", "Redux Toolkit", "React Router", "Tailwind CSS", "Material UI"],
    tags: ["#Ecommerce", "#StateManagement", "#FrontendArchitecture"],
    img: erp,
