...
const ProjectDetails = memo(({ title, description, url, tech, githubLink, img }: PROJECTDETAILS) => {
    ...
    return (
        <div
            className='w-full flex items-center justify-center py-10 flex-col max-w-150   gap-4 max-h-[300px] bg-white'
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
        >
         
            <div className="flex flex-col md:flex-row justify-evenly" >
                <div className='lg:col-span-7 max-w-[300px] relative aspect-video rounded-2xl overflow-hidden border border-white/10 group cursor-pointer'>
